...
def run_portfolio_simulation(start_capital, strategies_data, start_date, end_date):
    ...
    for key, strat in strategies_data.items():
        ...
        # Feature-Spalten definieren (alte Version - kompatibel mit aktuell trainierten Modellen)
        # Um die erweiterten Features zu nutzen, müssen die Modelle neu trainiert werden!
