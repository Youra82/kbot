...
class Exchange:
    # Unterstützte Timeframes von Bitget
    SUPPORTED_TIMEFRAMES = ['1m', '5m', '15m', '30m', '1h', '2h', '4h', '6h', '12h', '1d', '1w', '1M']
    ...
    def validate_timeframe(self, timeframe):
        """Validiert, ob ein Timeframe von Bitget unterstützt wird."""
        if timeframe not in self.SUPPORTED_TIMEFRAMES:
            raise ValueError(f"Zeitrahmen '{timeframe}' wird nicht unterstützt. Unterstützte: {', '.join(self.SUPPORTED_TIMEFRAMES)}")
        return True
